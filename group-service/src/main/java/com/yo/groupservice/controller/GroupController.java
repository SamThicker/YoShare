...
public class GroupController {
    ...
    public CommonResult getAvatarUploadUrl(@PathVariable(value = "id") String id,
                                           ...
                                           String type) throws IOException, XmlPullParserException, NoSuchAlgorithmException, InvalidKeyException, InvalidPortException, InvalidExpiresRangeException, InvalidBucketNameException, InsufficientDataException, InvalidEndpointException, ErrorResponseException {
